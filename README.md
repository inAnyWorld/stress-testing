...
```
go run main.go -c 1000 -n 100 -p curl/test.postman.member.curl.txt -r "name&age"
```

使用过程中,在 dynamic package 中自定义随机参数的方法, 在发送Http请求时, 会动态调用该方法动态生成随机参数

### 意见反馈

大佬github: https://github.com/link1st/go-stress-testing
